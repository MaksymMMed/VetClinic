        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalSex = table.Column<byte>(type: "tinyint", nullable: false),
                    AnimalKind = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcedureName = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Procedure", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Procedure_Receptions_AppointmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2", 0, "123", "Customer", "WWhite@gmail.com", true, false, null, "Walther", "WWHITE@GMAIL.COM", "WALTHER WHITE", "123", "0960025698", true, "123", "White", false, "Walther White" },
                    { "3", 0, "123", "Doctor", "LucyGray@gmail.com", true, false, null, "Lucy", "LUCYGRAY@GMAIL.COM", "LUCY GRAY", "123", "0960025653", true, "123", "Gray", false, "Lucy Gray" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Receptions",
                columns: new[] { "Id", "AnimalId", "DoctorId", "EndTime", "IsOver", "StartTime" },
                values: new object[] { "4", "1", "3", new DateTime(2023, 7, 20, 0, 47, 14, 301, DateTimeKind.Local).AddTicks(5512), true, new DateTime(2023, 7, 19, 22, 47, 14, 301, DateTimeKind.Local).AddTicks(5442) });

            migrationBuilder.InsertData(
                table: "Procedure",
                columns: new[] { "Id", "AppointmentId", "Price", "ProcedureName" },
                values: new object[] { "5", "4", 3500, (byte)3 });
