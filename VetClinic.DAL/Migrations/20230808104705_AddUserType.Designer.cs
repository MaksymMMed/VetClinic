...
namespace VetClinic.DAL.Migrations
{
    ...
    [Migration("20230808104705_AddUserType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetClinic.DAL.Entities.Animal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "125cdfba-e37f-47fb-ab74-19b09bd278c8",
                            Age = 2,
                            AnimalKind = (byte)1,
                            AnimalSex = (byte)1,
                            Description = "-",
            ...
            modelBuilder.Entity("VetClinic.DAL.Entities.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AnimalId = "1",
                            DoctorId = "3",
                            EndTime = new DateTime(2023, 8, 8, 15, 47, 5, 162, DateTimeKind.Local).AddTicks(9945),
                            IsOver = true,
                            StartTime = new DateTime(2023, 8, 8, 13, 47, 5, 162, DateTimeKind.Local).AddTicks(9888)
                        });
                });

            modelBuilder.Entity("VetClinic.DAL.Entities.BaseAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VetClinic.DAL.Entities.Customer", b =>
                {
                    b.HasBaseType("VetClinic.DAL.Entities.BaseAccount");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VetClinic.DAL.Entities.BaseAccount", null)
                        .WithMany()
